 ...
 *  Gestion de clientes
 *
 *  @package application/controllers/clientes
...
class Clientes extends CI_Controller
{
    ...
    public function agregar()
    {
        ...
        if ($this->input->post('cliente_tipo_id') == 1) {
            $cliente_id_padre = NULL;
        }
        ...
        $data   = array(
            ...
            'usuario_id_cliente'         => $this->input->post('usuario_id_cliente')
        );
