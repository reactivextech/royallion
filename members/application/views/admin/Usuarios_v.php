            ...
            <div class="modal-body">
                <form id="form1" data-parsley-validate novalidate role="form" autocomplete="off">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="usuario_nombre" name="usuario_nombre" placeholder="Nombre" parsley-trigger="change" required="">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="usuario_apellido" class="control-label">Apellido</label>
                                <input type="text" class="form-control" id="usuario_apellido" name="usuario_apellido" placeholder="Apellido" required="">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="usuario_user" name="usuario_user" placeholder="Nombre de usuario" required="" data-parsley-length="[3, 40]">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="usuario_pass" class="control-label">Contraseña</label>
                                <input type="password" class="form-control" id="usuario_pass" name="usuario_pass" placeholder="Pass">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="form-group">
                                ...
                                <select id="select_grupo" class="select2 select2-multiple" multiple="multiple" multiple data-placeholder="Seleccionar ..." name="my_multi_select1[]" required="">
                                </select>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="usuario_id_cliente" class="control-label"># Cliente</label>
                                <input type="text" class="form-control" id="usuario_id_cliente" name="usuario_id_cliente" placeholder="Id de Cliente" required="" data-parsley-length="[3, 40]">
                            </div>
                        </div>
                    </div>
...
<div id="modal_grupo_form" class="modal fade bs-example-modal-sm" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true" style="display: none;">
    <div class="modal-dialog modal-sm">
        <div class="modal-content">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="grupo_nombre" name="grupo_nombre" placeholder="Descripción grupo">
                            </div>
                        </div>
                    </div>
                </form>
            ...
            <div class="modal-footer">
                <button type="button" id="btn-guardar" onclick="grupo_guardar()" class="btn btn-info waves-effect waves-light">Guardar</button>
            </div>
        </div><!-- /.modal-content -->
    </div><!-- /.modal-dialog -->
</div>
        ...
        var table = $('#datatable').DataTable({
            ...
            "createdRow": function(row, data, index) {
                if (data[3] == 'activo') {
                    ...
                    $("td", row).eq(3).html("<span class='btn-info btn-trans btn-sm m-b-5'>" + data[3] + '</span>');
                }
                //  Botones
    ...
    function editar(id) {
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                $('[name="usuario_id_cliente"]').val(data.usuario_id_cliente);
