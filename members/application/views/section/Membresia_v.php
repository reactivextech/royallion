                    ...
                    <div class="row">
                       <div class="col-md-4 col-sm-6 col-xs-12">
                           <div class="form-group">
                                ...
                                <select class="form-control select2" id="cliente_id_padre" name="cliente_id_padre" required>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="col-md-3 col-sm-6 col-xs-12">
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" id="planes_costo" name="planes_costo" placeholder="<?php echo($tbl_moneda[0]->moneda_simbolo) ?>" required="" data-parsley-type="number">
                            </div>
                        </div>
                        ...
                        <div class="col-md-1 col-sm-1 col-xs-6" style="padding-top: 22px;">
                            <div class="form-group">
                                <button type="submit" id="btn-guardar" onclick="enviar_datos()" class="btn btn-success waves-effect waves-light" ><i class="fa fa-check-circle"></i></button>
                            </div>
                        </div>                                               
                    </div>
                </form>
            ...
            <div class="modal-body">
                <div class="row">
                    ...
                    <div class="col-md-4 col-sm-6 col-xs-12">
                        ...
                        <br>
                        <strong class="col-md-6 text-left pleft">Modificar Monto: </strong><span id="cobrador"></span>
                    </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function(){  
        ...
        var table = $('#datatable').DataTable({
            ...
            "createdRow": function ( row, data, index ) {
                ...
                $("td", row).eq(-1).append('<div class="btn-group"><a class="btn btn-default waves-effect waves-light btn-ver-detalle" onclick="ver_detalle('+data[0]+')"><i class="fa fa-eye"></i></a><a class="btn btn-default waves-effect waves-light btn-eliminar" onclick="eliminar('+data[0]+')"><i class="fa fa-times"></i></a></div>');
            }
        });
        ...
        // Botones cabecera
        $("div.btn-datatable").html('<a id="refresh" class="btn btn-default waves-effect waves-light"><i class="fa fa-refresh"></i></a><a id="agregarRegistro" class="btn-agregar">Agregar Plan <i class="fa fa-plus"></i></a>');
    ...
    */
    ...
    function mostrar_planes(){
        $.ajax({
            url: "<?=base_url(strtolower($this->router->class.'/mostrar_planes')); ?>",
            type:  'POST',
            beforeSend: function () {
    ...
    function ver_detalle(id) {
        $.ajax({
            ...
            success: function(data) {
                ...
                $('span#pago_cliente_fecha').html(data.planes_clientes_fecha);
                // $('span#pago_cliente_hora').html(data.pago_cliente_hora);
                // $('span#pago_forma_descripcion').html(data.pago_forma_alias);
                $('span#pago_cliente_estado').html(data.planes_clientes_estado);
                $('span#pago_cliente_monto_plan').html(data.planes_clientes_monto);
                ...
                $('span#pago_cliente_desde_hasta').html(data.planes_clientes_desde_hasta);
                $('span#cobrador').html(data.planes_clientes_modificar_monto);
                
                $('#modal-form-ver-detalle').modal('show'); // show bootstrap modal when complete loaded
                $('.modal-title').text('Detalles del plan n° ' + id); // Set title to Bootstrap modal title
    ...
    function guardar() {
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                notificacion("success", "Plan guardado!", "toast-top-right");
            },
            error: function(jqXHR, textStatus, errorThrown) {
    ...
    function eliminar(id) {
        swal({
            title: "¿Eliminar el plan para este ciente?",
            type: "warning",
            ...
            $.ajax({
                ...
                success: function(data) {
                    $('#datatable').dataTable().fnDraw('page'); // Recargar en la misma página
                    swal.close();
                    notificacion("success", "Plan n° " + id + " eliminado.", "toast-bottom-right");
                },
                error: function(jqXHR, textStatus, errorThrown) {
