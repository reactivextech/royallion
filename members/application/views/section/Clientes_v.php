            ...
            <div class="modal-body">
                <form id="form-agregar" name="form-agregar" data-parsley-validate novalidate role="form" autocomplete="off">
                    ...
                    <div class="row">
                        <div class="col-md-4 col-sm-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="cliente_nombre" name="cliente_nombre" placeholder="Nombre" parsley-trigger="change" data-parsley-length="[3,35]" required="">
                            </div>
                        </div>
                        <div class="col-md-4 col-sm-4">
                            <div class="form-group">
                                <label for="cliente_apellido" class="control-label">Apellido</label>
                                <input type="text" class="form-control" id="cliente_apellido" name="cliente_apellido" placeholder="Apellido" parsley-trigger="change" data-parsley-length="[3,35]" required="">
                            </div>
                        </div>
                        <div class="col-md-4 col-sm-4">
                            <div class="form-group">
                    ...
                    <div class="row">
                        <div class="col-md-3 col-sm-3">
                            <div class="form-group">
                                ...
                                <input type="text" min="0" class="form-control" id="cliente_ci" name="cliente_ci" placeholder="Solo números" data-parsley-type="number">
                            </div>
                        </div>
                        <div class="col-md-3 col-sm-3">
                            <div class="form-group">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3 col-sm-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="cliente_cel" name="cliente_cel" placeholder="Solo números" data-parsley-type="number" required>
                            </div>
                        </div>
                        <div class="col-md-6 col-sm-6">
                            <div class="form-group">
                                <label for="cliente_direccion" class="control-label">Dirección</label>
                                <input type="text" class="form-control" id="cliente_direccion" name="cliente_direccion" placeholder="" parsley-trigger="change" data-parsley-length="[5,25]" required="">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                    ...
                    <div class="row">
                            ...
                            <div class="form-group">
                                <div class="form-group m-l-10">
                                    <div class="checkbox checkbox-primary">
                                        <input id="planes_clientes_modificar_monto" type="checkbox" name="planes_clientes_modificar_monto" value="" onclick="valida(this.checked)">
                        ...
                        <div class="col-md-3 col-sm-6">
                            <div class="form-group">
                                <input type="text" class="form-control" id="usuario_id_cliente" name="usuario_id_cliente" placeholder="Id del Cliente" parsley-trigger="change" data-parsley-length="[0,8]">
                            </div>
                        </div>
