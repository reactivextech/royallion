    ...
    <div class="container">
        <div class="row">
            <div class="col-xs-12 copyright text-center">
                Copyright © <?= date("Y") ?>
                <!-- r<strong>{elapsed_time}</strong>s. -->
                &bull; Versión:
                <?php echo (ENVIRONMENT === 'development') ? '<strong>' . CI_VERSION . '</strong>' : '' ?> &bull; <span>Desarrollado por <strong><a href="#!" style="color:#f7a813;">Impulse Technologies</a></strong></span>
            </div>
        </div>
    </div>
</footer>
...
<script src="<?= base_url('template/assets/js/app/File.js') ?>"></script>
