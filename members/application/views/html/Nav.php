        ...
        <div class="container active">
            ...
            <div class="topbar-left">
                <a href="<?= base_url('') ?>" class="logo">
                    ...
                    <span><img src="<?= base_url('template/') ?>assets1/img/icono-acciona-members.png" alt="logo" style="height: 44px;"></span>
                </a>
            </div>
            <!-- End Logo container-->
                ...
                <ul class="nav navbar-nav navbar-right pull-right">
                    ...
                    <li class="dropdown user-box">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a href="<?= base_url('login/cerrar_sesion') ?>"><i class="fa fa-sign-out"></i> Cerrar sesión</a></li>
                        </ul>
                    </li>
                </ul>
                <div class="menu-item">
