                ...
                <div class="col-lg-3 col-sm-6">
                    ...
                    <div class="contest-details-wrapper footer-icons">
                        <div class="single-item w-2">
                            <a href="#!" target="_blank"><i class="fa fa-facebook fa-2x iconcolor"></i></a>
                        </div>
                        <div class="single-item w-2">
                    ...
                    <div class="footer-widget mb-30">
                        <div class="contest-details-wrapper">
                            <div class="google-map">
                                <iframe src="https://maps.google.com/maps?width=100%25&amp;height=600&amp;hl=en&amp;q=Centro%20Ciudad%20Comercial%20Tamanaco%20(CCCT)+(My%20Business%20Name)&amp;t=&amp;z=14&amp;ie=UTF8&amp;iwloc=B&amp;output=embed" width="100%" height="200" style="border:0;" allowfullscreen="" loading="lazy"></iframe>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-6">
                    <div class="card-list text-md-right text-center">
                        Auditado por <a href="about#balance"><img src="./assets/images/crowe.png" alt="icon"></a>
                    </div>
                </div>
            </div>
        </div>
